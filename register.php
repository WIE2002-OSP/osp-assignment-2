...
<head>
    <meta charset="UTF-8">
    <!-- Required to be import here for checking checkbox XD -->
            ...
            <div class="register">
                ...
                <form action="<?php echo ($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="user_email" class="form-control <?php echo (!empty($error)) ? 'is-invalid' : ''; ?>" value = "<?php echo $user_email; ?>" required>
