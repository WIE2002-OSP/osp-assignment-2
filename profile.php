                    ...
                    <div class="">
                        <div class="">
                            <div class="card-list">
                                ...
                                <div class="column">
                                    <a href="joined-quiz-category.php?category=<?php echo $value ?> "
                                        class="brand-text">
                                        <div class="card" style="width: 18rem;">
                                            <img class="card-img-top"
                                                style="height:160px; border-bottom: 1px solid #f2f2f2"
                    ...
                    <div class="">
                        <div class="">
                            <div class="card-list">
                                <?php foreach ($category as $key => $value) : ?>
                                <div class="column">
                                    <a href="created-quiz-category.php?category=<?php echo $value ?> "
                                        class="brand-text">
                                        <div class="card" style="width: 18rem;">
                                            <img class="card-img-top"
                                                style="height:160px; border-bottom: 1px solid #f2f2f2"
