            ...
            <div class="register">
                ...
                <form action="<?php echo ($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="email" name="user_email" class="form-control <?php echo (!empty($email_error)) ? 'is-invalid' : ''; ?>" required>
                        <span class="invalid-feedback"><?php echo $email_error; ?></span>
                    </div>    
                    <div class="form-group">
                        <i class="fa-solid fa-lock"></i>
                        <label>Password: </label>
                        <input type="password" name="user_password" class="form-control <?php echo (!empty($pass_error)) ? 'is-invalid' : ''; ?>" minlength="8" required>
